  ...
  _: {
    ...
    routes: [
      ...
      },
      {
        ...
        params: null,
        load: () => Promise.resolve().then(() => __toModule(require("./entries/endpoints/api/recipeSummary.json.ts.js")))
      },
      {
        type: "endpoint",
        pattern: /^\/api\/recipes\.json$/,
        params: null,
        load: () => Promise.resolve().then(() => __toModule(require("./entries/endpoints/api/recipes.json.ts.js")))
      },
      {
        type: "endpoint",
        pattern: /^\/api\/random\.json$/,
        params: null,
        load: () => Promise.resolve().then(() => __toModule(require("./entries/endpoints/api/random.json.ts.js")))
      },
      {
        type: "endpoint",
        pattern: /^\/api\/([^/]+?)\.json$/,
        params: (m) => ({ recipeName: m[1] }),
        load: () => Promise.resolve().then(() => __toModule(require("./entries/endpoints/api/_recipeName_.json.ts.js")))
      }
    ]
  }
};
